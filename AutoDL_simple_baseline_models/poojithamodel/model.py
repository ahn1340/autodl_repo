...
class TFDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            x = mfcc(wav.flatten(), sr=16000, n_mfcc=13)
...
class Model():
    def __init__(self, metadata):
        ...
        self.pytorchmodel = LSTM(input_dim=13, hidden_dim=100, batch_size=64)
        ...
        # PyTorch Optimizer and Criterion. Multilabel classification; therefore we use BCE
    ...
    def trainloop(self, criterion, optimizer, steps):
        ...
        for i in range(steps):
            ...
            # change shape to (batch_size, input_size, seq_legnth) -> (seq_len, batch, input)
